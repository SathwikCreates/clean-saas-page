                ...
                <div className="bg-zinc-950 border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black ring-1 ring-white/5 relative overflow-hidden">
                    ...
                    <div className="text-center mb-8 relative z-10">
                        ...
                        <p className="text-zinc-400 text-sm font-medium">
                            Sign in to continue to AdCoach.
                        </p>
                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href="/forgot-password" className="text-xs text-zinc-400 hover:text-white hover:underline transition-colors font-medium">
                                        Forgot Password?
                                    </Link>
                                </div>
                                <Input
